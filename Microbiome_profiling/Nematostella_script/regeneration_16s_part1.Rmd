...
# mv *_R1.fastq & *_R2.fastq files to the folder to be used in dada2:("/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella")

#assign working directory to "path" 
path<-("/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella")
```
...
head(out)
tail(out)
write.csv(out, "/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_trim_statistics.csv", row.names = TRUE)
...
saveRDS(seqtab.nochim, file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_all_seqtab.nochim.rds")
write.csv(seqtab.nochim, file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_all_seqtab.nochim.csv")
...
write.csv(track,file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_readstats.csv",row.names=TRUE,quote=FALSE)
```
...
saveRDS(taxa.plus, file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_taxaplus.rds")
saveRDS(taxa, file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_taxa.rds")
write.csv(taxa.plus, file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_mr16s_taxaplus.csv")
write.csv(taxa, file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_mr16s_taxa.csv")
...
seqtab.nochim <- readRDS("/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_all_seqtab.nochim.rds")
taxa <- readRDS("/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_taxa.rds")
taxa.plus <- readRDS("/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_taxaplus.rds")
```
...
samdf = read.csv("sample_info_reg_stella2.csv")
dim(samdf)
head(samdf)
samdf_all=samdf
...
#otu_table()   OTU Table:         [ 120 taxa and 11 samples ]
##sample_data() Sample Data:       [ 11 samples by 3 sample variables ]
#tax_table()   Taxonomy Table:    [ 120 taxa by 6 taxonomic ranks ]
...
library(dada2)
path='//projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/16s_all.fasta'
...
ps.cleanest
#116 taxa and 9 samples

seqtab.cleanest <- data.frame(otu_table(ps.cleanest))
write.csv(seqtab.cleanest,file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_seqtab.rev.cleanest.csv")

##save cleaned phyloseq object
saveRDS(ps.cleanest,file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/phyloseq.cleanest.all.rds")
...
ps.rare
#phyloseq-class experiment-level object
#otu_table()   OTU Table:         [ 116 taxa and 9 samples]
...
#saving
saveRDS(ps.rare,file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/phyloseq.rarefied.rds")
#save as csv file
write.csv(seqtab.rare, file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_seqtab.rev.cleanest.rare_1k")
...
ps.rare.1k = readRDS("/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/phyloseq.rarefied.rds")
...
write.csv(seq.trim,file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_seqtab.rev.cleanest.trim.csv")
#remove sample info
seq.trim <- seq.trim.allinfo[,3:101]
...
saveRDS(ps.trim,file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/phyloseq.cleanest.trim.rds")


#### rarefy trimmed data #####
library(vegan)

ps.trim = readRDS("/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/phyloseq.cleanest.trim.rds")
...
ps.trim.rare <- phyloseq(otu_table(seqtab.rare, taxa_are_rows=FALSE),
                         sample_data(samdf.rare),
                         tax_table(taxa2))
ps.trim.rare #99 taxa and 10 samples
...
#saving
saveRDS(ps.trim.rare,file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/phyloseq.trim.rarefied.1k.rds")

write.csv(seqtab.rare, file="/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/Stella_16s_seqtab.rev.cleanest.rare_1k")

### data files - decontaminated, trimmed, rarefied ####

ps.trim.rare.1k = readRDS("/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/phyloseq.trim.rarefied.1k.rds")
...
ps.rare.1k = readRDS("/projectnb/coral/jk_data/proj4_Regeneration/1_Raw_reads/Stella/phyloseq.trim.rarefied.1k.rds")
