...
ps.clean <- phyloseq(otu_table(seqtab.clean, taxa_are_rows=FALSE), 
                    ...
                    tax_table(taxa2))
ps.clean#[ 591 taxa and 10 samples
...
ps.trim.rare <- phyloseq(otu_table(seqtab.trim.rare, taxa_are_rows=FALSE), 
                    ...
                    tax_table(taxa2))
ps.trim.rare# 387 taxa and 10 samples
...
#treatment    1 0.0195  0.0195   0.059  0.814
#Residuals    8 2.6364  0.3295
...
summary(a.div) 
#   Df Sum Sq Mean Sq F value Pr(>F)
#treatment    1   10.0   10.04   0.161  0.699
#Residuals    8  500.5   62.56      
```
...
ggsave(plots.lin, filename = "Aip_diversity_plots_lineage_clean_nolabs.pdf", width=5,height=2, units=c("in"), useDingbats=FALSE)
```
